<?php
    ...
    echo '<table class = "table"><tr><th>Item Name</th><th>Main Image</th><th>Price</th><th>Search</th><th>Stock</th><th>Description</th><th>Gallery</th></tr>';
    ...
    foreach ($products as $itemName => $itemData) {
        ...
        echo "<td>".$itemData['price']."</td><td>".$itemData['index']."</td><td>".$itemData['stock']."</td><td><textarea>".$itemData['description']."</textarea></td>";
